...
Contains general utility functions that can be used across different evaluation scripts.
"""
...
def calculate_word_f1_metrics(prediction: str, reference: str) -> Dict[str, float]:
    """
    Calculate word-level F1, precision, and recall between prediction and reference.
